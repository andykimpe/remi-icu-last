...
%patch -P N1 -p2 -R -b .icu8198.revert.icu5431.patch
%patch -P N2 -p1 -b .icu8800.freeserif.crash.patch
%patch -P N3 -p1 -b .icu7601.Indic-ccmp.patch
%patch -P N4 -p1 -b .icu9948.mlym-crash.patch
%patch -P N5 -p1 -b .gennorm2-man.patch
%patch -P N6 -p1 -b .icuinfo-man.patch
%patch -P N7 -p1 -b .icu10143.memory.leak.crash.patch
%patch -P N8 -p1 -b .icu10318.CVE-2013-2924_changeset_34076.patch
%patch -P N9 -p1 -b .icurhbz1074549.CVE-2013-5907.patch
%patch -P N10 -p1 -b .icu-testtwodigityear.patch
%patch -P N11 -p1 -b .do-not-fail-intltest-because-of-changed-data.patch
